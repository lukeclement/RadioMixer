...
public class main{
    public static void main(String[] args){
        ...
        */
        ...
        //Writing file 1(no edits, experiment 1).
        try{
            ...
            print_line.close();
        }catch(Exception ex){System.out.println("File not written to");}
        //Writing file 2(no edits, experiment 2).
        try{
        ...
        //Finding anomolies and printing to file.
        ...
        //Systematically removing anomolies.
        for(int a:anomolies){
        ...
        //A is IF (Input Frequency), B is input.
        double meanA=sumA/(9);
        double meanC=sumC/(9);
        double x=0;
        double y=0;
        ...
        //Writing files (edited).
        //Removing first 4 anomolies.
        if(p<4){
                //Classing each attempt for each experiment and writing to it.
                ...
                try{
                    ...
                    print_line.close();
                }catch(Exception ex){System.out.println("Problem found \n" +ex);}
                ...
                try{
                    ...
                    writer.close();
                }catch(Exception ex){System.out.println("OHNO " +ex);}
                ...
                try{
                  File file=new File(fNOOO2);
                    ...
                    System.out.println("Problem from line 184-208");
                    System.out.println(ex);
                }
                
            }
            //Moving on to the next anomoly.
            p++;
        }
    }
}
